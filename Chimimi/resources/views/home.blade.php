...
@section('content')
    ...
    <div class="position-relative"
        ...
        <div class="position-absolute start-50"
            ...
            <span
                style="background:#fff;border-radius:50%;padding:8px;display:inline-block;box-shadow:0 10px 36px rgba(0,0,0,0.16);">
            ...
            <div class="text-center text-white"
                ...
                <h1 class="display-4 fw-bold mb-3" style="color:#ff6f61;text-shadow:0 2px 12px rgba(255,224,102,0.18);">
                    Discover
                    the Joy of
                    Risoles!</h1>
                <p class="lead mb-0" style="color:#ff6f61;text-shadow:0 2px 12px rgba(255,111,97,0.12);font-weight:500;">
                    Indulge
                    in crispy, golden bites filled with irresistible flavors. Elevate your snacking experience with Chimimi!
                </p>
            </div>
        </div>
    </div>
            ...
            <div class="row justify-content-center align-items-center mb-5">
                ...
                <div class="col-lg-7">
                    <div class="card shadow-lg p-4 p-md-5"
                        style="background:#fffbe6;border-radius:20px;border: 2.5px solid #ff6f61;">
                        <h1 class="fw-bold mb-3" style="color:#ff6f61;font-size:2.1rem;letter-spacing:0.6px;">Chimimi
                            Risoles</h1>
                        ...
                        <p class="text-muted mb-4" style="font-size:0.95rem;">
                            Made with premium ingredients and a touch of love — perfect as a snack or party bites. Try our
                            most-loved flavors below.
                        </p>

                        <div class="d-flex flex-wrap gap-2">
                            <a href="{{ route('products') }}" class="btn px-4 py-2"
