                ...
                <div class="card shadow-sm p-3" style="border-radius:12px;border:1px solid rgba(255,111,97,0.08);background:#fff;">
                  <div class="d-flex justify-content-between align-items-start mb-2">
                    <div>
                      ...
                      <div class="small text-muted">{{ $history->created_at->format('d M Y H:i') }} · by {{ $history->user->username ?? $history->user->email ?? '-' }}</div>
                    </div>

                    <div class="text-end">
                      <span class="badge rounded-pill px-3 py-2 fw-bold" style="background:#28a745;color:#fff;font-size:0.9rem;">Paid</span>
                    </div>
                  </div>

                  <hr style="margin:8px 0;border-top:1px dashed rgba(0,0,0,0.06)">

                  <div class="mb-2 fw-semibold" style="color:#333;">Products</div>
                  ...
                  <div class="mt-3 d-flex justify-content-between align-items-center">
                    ...
                    <div class="fw-bold" style="color:#ff6f61;font-size:1.05rem;">
