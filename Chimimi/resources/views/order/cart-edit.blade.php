                    ...
                    <div class="card shadow-lg p-4"
                        ...
                        <form method="POST" action="{{ route('cart.update', [$product->id, $productType]) }}">
                            ...
                            <div class="mb-4">
                                ...
                                <div class="text-muted" style="font-size:1rem;">Ingredients: {{ $product->ingredients }}
                                </div>
                            </div>
                            <div class="mb-4">
                                ...
                                <div class="d-flex gap-4 justify-content-center">
                                    <div class="form-check">
                                        <input class="btn-check" type="radio" name="product_type" id="type-frozen"
                                            value="Frozen" {{ $productType == 'Frozen' ? 'checked' : '' }}>
                                        <label class="btn btn-outline-warning fw-bold px-4 py-2" for="type-frozen"
                                            style="border-radius:28px;border-width:2.5px;white-space:nowrap;">
                                            Frozen - Rp. {{ number_format($product->price_frozen, 0, ',', '.') }}
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <input class="btn-check" type="radio" name="product_type" id="type-cooked"
                                            value="Cooked" {{ $productType == 'Cooked' ? 'checked' : '' }}>
                                        <label class="btn btn-outline-danger fw-bold px-4 py-2" for="type-cooked"
                                            style="border-radius:28px;border-width:2.5px;white-space:nowrap;">
                            ...
                            <div class="mb-4">
                                <label class="form-label fw-bold mb-2"
                                    style="color:#f17807;font-size:1.1rem;">Quantity</label>
